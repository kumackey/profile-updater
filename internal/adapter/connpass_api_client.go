...
func (c ConnpassAPIClient) FetchEventList(ctx context.Context, userNickname string) ([]domain.ConnpassEvent, error) {
	...
	list := make([]domain.ConnpassEvent, 0, len(response.Events))
